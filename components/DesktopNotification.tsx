...
export default function DesktopNotification() {
  ...
  return (
    <div
      className="hidden md:block fixed top-6 right-6 z-[70] max-w-sm w-full"
      style={{
        transform: show ? 'translateX(0)' : 'translateX(calc(100% + 48px))',
        transition: 'transform 0.4s ease-in-out',
      }}
    >
      <div className="bg-white rounded-xl shadow-xl border border-outline-variant p-4 overflow-hidden relative">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-hope-amber/10 flex items-center justify-center shrink-0">
            <span className="material-symbols-outlined text-hope-amber text-xl">favorite</span>
          </div>
          <div className="flex-1 min-w-0">
            ...
            <p className="font-body-md text-[12px] text-on-surface-variant mt-0.5 leading-tight">
              donated{' '}
